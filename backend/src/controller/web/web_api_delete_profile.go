...
func (c *Controller) reqAPIV1DeleteProfile(w http.ResponseWriter, r *http.Request) gousuchi.IResponse {
	...
	if err != nil {
		return gousuchi.InternalServerError(r, "Can't delete profile: %s", err)
	}

	return gousuchi.JSON(r, map[string]interface{}{}).
		WithDetailedMessage("Deleted profile")
}
