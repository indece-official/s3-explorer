...
func (c *Controller) reqAPIV1DeleteProfileBucket(w http.ResponseWriter, r *http.Request) {
	var err error
	...
	if err != nil {
		log.Errorf("%s %s 500 - Can't delete bucket: %s", r.Method, r.RequestURI, err)
	...
	log.Infof("%s %s 200 - Deleted bucket", r.Method, r.RequestURI)
